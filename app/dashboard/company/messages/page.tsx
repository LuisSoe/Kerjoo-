...
const conversations = [
  {
    ...
    lastMessage: "Saya sudah menyelesaikan mockup untuk halaman utama. Bisa direview?",
  ...
  },
  {
    ...
    lastMessage: "Terima kasih untuk feedbacknya. Akan saya revisi sesuai permintaan.",
  ...
  },
  {
    ...
    lastMessage: "Kapan bisa meeting untuk discuss technical requirements?",
  ...
  },
  {
    ...
    lastMessage: "Database schema sudah ready. Bisa mulai development phase.",
...
export default function CompanyMessages() {
  ...
  const handleSendMessage = async () => {
    ...
    setIsSending(true)
    try {
      const sentMessage = await messageService.sendMessage(selectedConversation.id, user.id || "company_1", newMessage)
              ...
              {isLoading ? (
                ...
                <>
                  {messages.map((message) => {
                    const isOwn = message.senderId === (user?.id || "company_1")
                    return (
